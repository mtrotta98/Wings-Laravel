...
<div class="card card-info">
    ...
    <form method="POST" id="form-agregar">
            ...
            <div class="col-4">
              ...
              <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="observaciones" id="observaciones" aria-describedby="helpId" placeholder="">
                </div>
              </div>
          </div>
          <div class="row">
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="ingreso" id="ingreso" aria-describedby="helpId" placeholder="">
                </div>
            </div>
      ...
      <div class="card-footer">
        <button type="submit" class="btn btn-info" onclick="agregar('alumno', '/nuevoAlumno/agregar')">Guardar</button>
      </div>
      <!-- /.card-footer -->
    </form>
  </div>
