...
<div class="card card-info">
    ...
    <form method="POST" id="form-agregar">
          ...
          <div class="row">
              ...
              <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="editora" id="editora" aria-describedby="helpId" placeholder="">
                </div>
              </div>
          </div>
          <div class="row">
      ...
      <div class="card-footer">
        <button type="submit" class="btn btn-info" onclick="agregar('libro', '/newLibro/agregar', '/libros')">Guardar</button>
      </div>
      <!-- /.card-footer -->
    </form>
  </div>
