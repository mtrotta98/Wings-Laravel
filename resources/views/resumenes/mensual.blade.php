                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          @endif
                          <td>{{ $cobro->monto }}</td>
                          <td><a href="{{ url('/resumen/editar', $cobro->id) }}"><i class="fas fa-edit"></i></a></td>
                          <td><a href="#" onclick="borrar({{$cobro->id}}, 'ingreso', '/resumen/borrarIngreso/', '/resumenMensual')"><i class="fas fa-trash-alt"></i></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
                    ...
                    <tbody>
                      @foreach ($gastos as $gasto)
                        <tr>
                          ...
                          <td>{{ $gasto->fecha }}</td>
                          <td>{{ $gasto->monto }}</td>
                          <td><a href="{{ url('/resumen/editarE', $gasto->id) }}"><i class="fas fa-edit"></i></a></td>
                          <td><a href="#" onclick="borrar({{$gasto->id}}, 'egreso', '/resumen/borrarEgreso/', '/resumenMensual')"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                      @endforeach
                    </tbody>
                  </table>
